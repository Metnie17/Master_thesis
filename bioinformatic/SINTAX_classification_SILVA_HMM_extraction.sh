...
extracted_soil_sample="/user_data/Metnie17/With_CPU_use/extraction/hmmer/database_based/extraction/LIB-MJ050-H8/"
result_dir="/user_data/Metnie17/With_CPU_use/classification/sintax/hmmer/extraction/database_based"
